...
coverage_df = check_bivariate_parameter_coverage(data_generator, gen_args, model, 2000, 100, θtrue, [[1, 2], [1, 3], [2, 3]], show_progress=true, distributed_over_parameters=true)
println(coverage_df)
rmprocs(workers())
