...
@time bivariate_confidenceprofiles!(model, 500, profile_type=LogLikelihood(), method=BracketingMethodIterativeBoundary(10, 10, 10), confidence_level=0.95, existing_profiles=:overwrite, save_internal_points=true)
