...
# plots = []
# for sub_df in groupby(pnts_to_reach_coverage_df, [:θindices, :hullmethod, :quantile])
#   sub_df_filt = subset(sub_df, :num_points => ByRow(!=(-10)))
#   plt = @df sub_df_filt groupedbar(:coverage_level, :num_points; group=:method_name, 
#                                            # ylimits=(0.6, 1.0), 
#                                            # xticks=coverage_levels, 
#                                            format...)
#   push!(plots, plt)
# end
# 
