...
if !isfile(joinpath(output_location, "univariate_parameter_coverage.csv"))
    uni_coverage_df = check_univariate_parameter_coverage(data_generator, training_gen_args, model, 500, θ_true, collect(1:7), show_progress=true, distributed_over_parameters=false)
