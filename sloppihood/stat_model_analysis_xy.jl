...
hline!([xy_true[2]],color=:gray,lw=2,legend=false)
display(plt)
savefig(plt,"./stat_likelihood_quadratic.svg")
...
hline!([xy_true[2]],color=:gray,lw=2,legend=false)
display(plt)
savefig(plt,"./stat_likelihood_comparison.svg")
...
display(plt)
savefig(plt,"./stat_likelihood_n.svg")
...
display(plt)
savefig(plt,"./stat_likelihood_p.svg")