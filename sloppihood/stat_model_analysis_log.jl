...
display(plt)
savefig(plt,"./stat_log_param_likelihood.svg")
...
hline!([XY_true[2]],color=:gray,lw=2,legend=false)
display(plt)
savefig(plt,"./stat_log_param_likelihood_quadratic.svg")
...
hline!([XY_true[2]],color=:gray,lw=2,legend=false)
display(plt)
savefig(plt,"./stat_log_param_likelihood_comparison.svg")
...
display(plt)
savefig(plt,"./stat_log_param_n.svg")
...
display(plt)
savefig(plt,"./stat_log_param_p.svg")
